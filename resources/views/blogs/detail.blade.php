                    ...
                    <div class="row">
                        <div class="other-blogs-box col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <a href="{{ route('blogs.show') }}">
                                <img src="../images/blogs_img/cach-lam-banh-bot-loc-2.jpg">
                                <p>Cách làm bánh bột lọc ngon và dễ dàng tại nhà 1</p>
                            </a>
                        </div>
                        <div class="other-blogs-box col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <a href="detail.php">
                                <img src="../images/blogs_img/cach-lam-banh-bot-loc-2.jpg">
                                <p>Cách làm bánh bột lọc ngon và dễ dàng tại nhà 2</p>
                            </a>
                        </div>
                        <div class="other-blogs-box col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <a href="detail.php">
                                <img src="../images/blogs_img/cach-lam-banh-bot-loc-2.jpg">
                                <p>Cách làm bánh bột lọc ngon và dễ dàng tại nhà 3</p>
                            </a>
                        </div>
                        <div class="other-blogs-box col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <a href="detail.php">
                                <img src="../images/blogs_img/cach-lam-banh-bot-loc-2.jpg">
                                <p>Cách làm bánh bột lọc ngon và dễ dàng tại nhà 4</p>
                            </a>
                        </div>
                    </div>
                </div>
